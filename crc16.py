...
def Crc16Calculator_CalculateCrc16(dataToBeCalculatedPtr,length):

        crc16 = 0xffff
        counter = 0
        while counter<length:
            item = int(ord(dataToBeCalculatedPtr[counter]))
            ...
            crc16 = ((crc16Table[(item ^ (crc16 >> 8)) & 0x00ff] ^ (crc16 << 8)) & 0xffff)
            counter +=1
        
        return crc16


print("Crc16 CCITT Calculations: "+str(Crc16Calculator_CalculateCrc16("1234",4)))