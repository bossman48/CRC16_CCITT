...
void Crc16Calculator_Initialize()
{
        const unsigned short polynomial = 0x1021;
        int counter =0;
		for ( ; counter < CRC16_TABLE_LENGTH; counter++)
        {
            unsigned short crcItemValue = 0;
            ...
            crc16Table[counter] = crcItemValue;
        }
}

unsigned short Crc16Calculator_CalculateCrc16(char* dataToBeCalculatedPtr,int length)
{
        ...
        {
            char item = dataToBeCalculatedPtr[counter];
...
int main(){
    printf("Crc16 CCITT Calculations: %d",Crc16Calculator_CalculateCrc16("1234",4));
    return 0;
}
